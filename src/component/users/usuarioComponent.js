...
import { listarUsuarios, consultarUsuario, agregarUsuario, modificarUsuario, eliminarUsuario } from "../../services/user/userService";
...
const UsarioComponent = () => {
  ...
  return (
    <>
      ...
      {listado ? (
        <ListarUsuariosComponent valores={listaUsuarios} irFormulario={handleFormulario}></ListarUsuariosComponent>
      ) : (
        <FormularioUsuarioComponent regresar={handleRegresar} agregarUsario={handleAgregar} modificarUsario={handleModificar} eliminarUsario={handleEliminar} usuario={usuario}
